...
#these DOCKER_IMAGE_VERSION variables should be set preferably in the file /opt/config/docker_version.txt
#Currently (20181126) all docker images have the latest version 1.4-STAGING-latest but the one - onap/aai-graphadmin:1.1-STAGING-latest
#Before was the latest version of most of docker images 1.3-STAGING-latest with the exception of two files: onap/aai-graphadmin:1.1-STAGING-latest and onap/spike:1.0-STAGING-latest
# Supposing that all versions are going to be synchronized BUT the one (onap/aai-graphadmin:1.1-STAGING-latest) we try to eliminate most of hardcoding of docker images version by doing this setting
RESOURCES_DOCKER_IMAGE_VERSION=${DOCKER_IMAGE_VERSION:-'1.4-STAGING-latest'}
TRAVERSAL_DOCKER_IMAGE_VERSION=${DOCKER_IMAGE_VERSION:-'1.4-STAGING-latest'}
GRAPHADMIN_DOCKER_IMAGE_VERSION=1.0-STAGING-latest
SEARCH_DATA_SERVICE_DOCKER_IMAGE_VERSION=${DOCKER_IMAGE_VERSION:-'1.4-STAGING-latest'}
DATA_ROUTER_DOCKER_IMAGE_VERSION=${DOCKER_IMAGE_VERSION:-'1.4-STAGING-latest'}
MODEL_LOADER_DOCKER_IMAGE_VERSION=${DOCKER_IMAGE_VERSION:-'1.4-STAGING-latest'}
SPARKY_BE_DOCKER_IMAGE_VERSION=${DOCKER_IMAGE_VERSION:-'1.4-STAGING-latest'}
CHAMP_DOCKER_IMAGE_VERSION=${DOCKER_IMAGE_VERSION:-'1.4-STAGING-latest'}
GIZMO_DOCKER_IMAGE_VERSION=${DOCKER_IMAGE_VERSION:-'1.4-STAGING-latest'}
SPIKE_DOCKER_IMAGE_VERSION=${DOCKER_IMAGE_VERSION:-'1.4-STAGING-latest'}
BABEL_DOCKER_IMAGE_VERSION=${DOCKER_IMAGE_VERSION:-'1.4-STAGING-latest'}
